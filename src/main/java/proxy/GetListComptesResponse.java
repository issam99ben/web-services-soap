...
/**
 * <p>Java class for getListComptesResponse complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="getListComptesResponse">
 *   <complexContent>
...
@XmlType(name = "getListComptesResponse", propOrder = {
    "_return"
})
public class GetListComptesResponse {
